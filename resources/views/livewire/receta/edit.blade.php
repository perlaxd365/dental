    ...
    <div class="form-body" >
        <div class="form-row">
            <div class="col-md-12 mb-3">
                ...
                <span class="label label-primary" wire:model='nombres_paciente'></span>
                <input wire:model='nombres_paciente' readonly type="text" class="form-control" placeholder="0.00 mm">
            ...
            <div class="col-md-12">
                ...
                <br>
                <textarea wire:model='recomendacion_rec' rows="2" placeholder="Ingresar recomendación" type="text" class="form-control"></textarea>
            </div>
        </div>
    ...
    <div class="form-actions">
        <div class="text-right">
            <button wire:click="update" wire:loading.attr="disabled" class="btn btn-primary" type="button"> <i
                    ...
                    aria-hidden="true"></i> Actualizar Receta</button>
